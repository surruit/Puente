...
var InputSourceKeyBoard = function(canvas){
    ...
    var pointerLockChange = function (e) {
        if (document.pointerLockElement === canvasLock){
    ...
    var pedirPuntero = function(){
        if (document.pointerLockElement !== canvasLock){ //si el elemento que esta capturando el puntero no es nuestro canvas, solicita capturar el puntero
            canvasLock.requestPointerLock();
        }
    }
    ...
    var startListeners = function(){
        ...
        canvasLock.addEventListener("click", pedirPuntero);
	};
